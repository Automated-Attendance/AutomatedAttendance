...
import StudentAttendanceTable from '../../src/public/components/tables/StudentAttendanceTable';

describe('<StudentAttendanceTable />', function() {
  ...
  it('should have a table', () => {
    const wrapper = shallow(<StudentAttendanceTable userPrivs={userPrivs}/>);
