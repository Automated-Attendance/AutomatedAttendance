...
var CameraPage = function (_React$Component) {
  _inherits(CameraPage, _React$Component);

  function CameraPage(props) {
    _classCallCheck(this, CameraPage);

    return _possibleConstructorReturn(this, (CameraPage.__proto__ || Object.getPrototypeOf(CameraPage)).call(this, props));
  }
...
ReactDOM.render(_react2.default.createElement(CameraPage, null), document.getElementById('main'));
